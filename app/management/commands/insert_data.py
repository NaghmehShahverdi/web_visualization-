...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        fields = ['Name', 'GENE', 'CHR',	'START',	'STOP',	'NSNPS',	'NPARAM',	'N',	'ZSTAT',	'SCZ_2022_P',	'SCZ_2018_P',	'SCZ_2014_P',	'SCZ_2011_P',	'alcohol_2022_P',	'MS_2018_P',	'sleep_2019_P',	'ALZ_2022_P',	'PTSD_2023_P',
                  'BMI_2018_P', 'CIG_2022_P', 'MDD_2023_P',	'MDD_2019_P',	'ADHD_2019_P',	'AN_2019_P',	'ASD_2017_P',	'BIP_2021_P',	'EDUC_2018_P',	'HGT_2018_P',	'INTEL_2018_P', 'NEURO_2018_P',	'SPE_RANK',	'SPE_VAL', 'GENE_EXP']
